...
timeout 60m ./supportScripts/launchRemoteExperiment.sh 50 200 1 4500 0 0 65000 {EXP_NAME} ${EXP_SET}
timeout 60m ./supportScripts/launchRemoteExperiment.sh 50 200 1 4500 0 0 80000 {EXP_NAME} ${EXP_SET}
